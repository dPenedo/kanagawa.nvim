...
function M.setup(colors, config)
	...
	return {
		...
		-- This forks implementations(dPenedo)
		-- RenderMerkdownLink
		-- TODO: usar theme.
		RenderMarkdownLink = { fg = theme.syn.special1 },

		-- TabLine
		TabLine = { fg = theme.syn.comment, bg = theme.ui.bg_m2 },
		TabLineSel = { fg = theme.syn.identifier, bg = theme.ui.bg_p2, bold = true },
